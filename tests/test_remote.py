...
class TestRemoteOperations(unittest.TestCase):
    ...
    def test_list_remotes_verbose(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            self.assertTrue(any("origin" in call and "/path/to/repo" in call for call in calls))
            self.assertTrue(any("upstream" in call and "/path/to/upstream" in call for call in calls))
